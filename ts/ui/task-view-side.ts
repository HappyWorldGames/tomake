...
export class TaskViewSideUI {
    ...
    taskDateTimeButton: HTMLButtonElement;
    ...
    constructor(tasksManager: TasksManager, projectsManager: ProjectsManager, customContextMenuUI: CustomContextMenuUI) {
        ...
        this.taskDateTimeButton = document.getElementById('task-date-button') as HTMLButtonElement;
    ...
    addSubTask(subTask: Task) {
        ...
        // Open Button
        const subTaskOpenButton = document.createElement('button') as HTMLButtonElement;
